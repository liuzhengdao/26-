...
![](picture/menu主菜单照片.jpg)

### 2.3 STEPS — 计步与健康估算

基于 MPU6050 加速度计的峰值检测 + 动态阈值算法统计步数，实时估算卡路里消耗和运动距离。

![](picture/step%20count照片.jpg)

### 2.4 SENSOR — 传感器数据

显示三轴加速度（X/Y/Z）、俯仰角（Pitch）、温度、电池电压，数据以 200Hz 频率采集。

![](picture/sensor照片.jpg)

### 2.5 CLOCK — 秒表与倒计时

**Clock 子菜单：**

![](picture/clock子菜单图片.jpg)

**秒表**（开始 → 计时 → 暂停 → 复位）：

| 未开始 | 计时中 | 暂停 |
|:---:|:---:|:---:|
| ![](picture/计时演示（未开始）.jpg) | ![](picture/计时演示（过程中）.jpg) | ![](picture/计时演示（暂停）.jpg) |

**倒计时**（编码器设置时间 → 运行 → 结束）：

| 设置中 | 过程中 | 结束 |
|:---:|:---:|:---:|
| ![](picture/倒计时演示（设置中）.jpg) | ![](picture/倒计时演示（过程中）.jpg) | ![](picture/倒计时演示（结束）.jpg) |
...
| 手电筒页面 | 演示效果 |
|:---:|:---:|
| ![](picture/手电筒页面照片.jpg) | ![](picture/手电筒功能演示.jpg) |

### 2.7 SETTING — 系统设置

**设置主页面：**

![](picture/setting照片.jpg)

**亮度调节**（5 档 + 进度条动画）：

| 最低 | 最高 |
|:---:|:---:|
| ![](picture/亮度调节演示（最低）.jpg) | ![](picture/亮度调节演示（最高）.jpg) |

**蓝牙开关：**

| 关闭状态 | 开启状态 |
|:---:|:---:|
| ![](picture/蓝牙设置页面（关闭状态）.jpg) | ![](picture/蓝牙设置页面（打开）.jpg) |
...
|:---:|:---:|:---:|:---:|
| ![](picture/clock子菜单图片.jpg) | ![](picture/计时演示（未开始）.jpg) | ![](picture/计时演示（过程中）.jpg) | ![](picture/计时演示（暂停）.jpg) |
